    ...
    <div className="max-w-3xl">
      ...
      {!bulkMode ? (
        ...
        <form onSubmit={handleBulkSubmit} className="space-y-6">
          ...
          <div className="card space-y-6">
            <div>
              <h2 className="section-label mb-3">{t("newAsset.sharedFields")}</h2>
          ...
          <div className="card space-y-3">
            <div className="flex items-center justify-between">
              <h2 className="section-label">{t("newAsset.bulkItems")}</h2>
              ...
              {items.map((item, idx) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-7 h-7 rounded-md text-xs transition-colors disabled:opacity-20"
            ...
            <button
              type="button"
              onClick={addItem}
              className="btn-ghost text-sm w-full mt-1"
            >
              {t("newAsset.addRow")}
            </button>
          </div>
